            ...
            <div className={`${'two'} ${'no-overflow'}`}>
              <div className={`${'item-two'}`}>
                <div className='nav-wrapper'>
                  ...
                  <a
                    href='https://www.canva.com/design/DADuoOP7ptc/5osLQWKX38pddqnzLf3BFw/view?utm_content=DADuoOP7ptc&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton'
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                  ...
                  {/* <a>
                    <img
                      className='key-logo'
                      src='https://raw.githubusercontent.com/Lambda-School-Labs/key-conservation-mobile/master/assets/images/keyFullWhite.png'
                    />
                  </a> */}
                </div>
              </div>
